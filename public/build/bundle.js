var app = (function () {
    ...
    */
    ...
    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-1el2dri-style";
    	style.textContent = "section.svelte-1el2dri.svelte-1el2dri{padding:1rem}section.svelte-1el2dri div.svelte-1el2dri{margin-bottom:2rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(p, file$2, 18, 6, 394);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h1, file$2, 8, 4, 177);
    			attr_dev(div0, "class", "svelte-1el2dri");
    			add_location(div0, file$2, 7, 2, 167);
    			add_location(p, file$2, 12, 4, 226);
    			attr_dev(div1, "class", "svelte-1el2dri");
    			add_location(div1, file$2, 11, 2, 216);
    			attr_dev(section, "class", "svelte-1el2dri");
    ...
    class Example extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1el2dri-style")) add_css$1();
